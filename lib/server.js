 ...
 * @param {string} opts.coin[='bzc'] - The coin for this wallet (btc, bch).
 ...
 * @param {string} opts.coin[='bzc'] - The expected coin for this wallet (btc, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['bzc', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='bzc'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'bzc'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'bzc'] - The coin for this transaction.
