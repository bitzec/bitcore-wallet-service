 ...
 * @param {string} opts.coin[='bzc'] - The coin for this wallet
 ...
 * @param {string} opts.coin[='bzc'] - The expected coin for this wallet
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.includes(['bzc', 'bit'], value.toLowerCase());
    },
  }];
